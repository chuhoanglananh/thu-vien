...
namespace QLTV
{
    public partial class frmNhanVien : Form
    {
        ...
        void KL()
        {
            ...
            txtGioiTinh.DataBindings.Add("Text", dgvNhanVien.DataSource, "DienThoai");

            txtMK.DataBindings.Clear();
            txtMK.DataBindings.Add("Text", dgvNhanVien.DataSource, "MatKhau");
        }
